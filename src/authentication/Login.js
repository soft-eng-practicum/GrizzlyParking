...
export const Login = observer(({navigation, ...props}) => {
  useEffect(() => {
    return () => {
  ...
  return (
    <ScrollView style={styles.background} behavior="padding">
      ...
      {this.RootStore != null &&
        this.RootStore.UserDomain != null &&
        this.RootStore.UserDomain.user != null && (
          <KeyboardAvoidingView style={styles.button} behavior="padding">
            <TouchableOpacity
              style={styles.buttonLogin}
              onPress={() =>
                RootStore.ParkingDomain.navigateToLanding(navigation)
              }>
      ...
      {(this.RootStore == null ||
        ...
        <View style={styles.inputWrapper}>
          <Icon name={'md-person'} size={28} style={styles.inputIconUser} />
      ...
      {(this.RootStore == null ||
        ...
        this.RootStore.UserDomain.user == null) && (
        <View style={styles.inputWrapper}>
          <Icon name={'ios-lock'} size={28} style={styles.inputIconPass} />
      ...
      {(this.RootStore == null ||
        ...
        <KeyboardAvoidingView style={styles.button} behavior="padding">
          <TouchableOpacity
            ...
            onPress={() =>
              RootStore.AuthDomain.navigateToCreateAccount(navigation)
            }>
      ...
      {(this.RootStore == null ||
        ...
        <KeyboardAvoidingView style={styles.button} behavior="padding">
          <TouchableOpacity
            ...
            onPress={() =>
              RootStore.AuthDomain.navigateToForgotPassword(navigation)
            }>
