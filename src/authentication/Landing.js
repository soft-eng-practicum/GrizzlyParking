...
export const Landing = observer(({navigation, ...props}) => {
  ...
  determineBackgroundColor = lot => {
    let parkingLot = RootStore.ParkingDomain.parkingLots.find(
      x => x.Name == lot,
    );
    ...
    <View style={styles.background}>
      <ScrollView>
        <View style={styles.scrollView}>
          ...
          <TouchableOpacity
            style={styles.imageContainer}
            onPress={() => parkingAlert('Parking Deck')}>
