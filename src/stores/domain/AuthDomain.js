...
export class AuthDomain {
    ...
    login(navigation) {
        auth()
        .signInWithEmailAndPassword(this.rootStore.LoginUI.username, this.rootStore.LoginUI.password)
        .then(user => {
    ...
    createAccount(navigation) {
        auth()
        .createUserWithEmailAndPassword(this.rootStore.CreateAccountUI.email, this.rootStore.CreateAccountUI.password)
        .then(user => {
            this.rootStore.UserDomain.user = user;
            this.rootStore.ParkingDomain.navigateToLanding(navigation);
        })
